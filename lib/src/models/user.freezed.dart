...
mixin _$User {
 ...
 String get id => throw _privateConstructorUsedError; String? get firstName => throw _privateConstructorUsedError; String? get lastName => throw _privateConstructorUsedError; String? get email => throw _privateConstructorUsedError; String? get phoneNumber => throw _privateConstructorUsedError; UserRole get role => throw _privateConstructorUsedError; String? get image => throw _privateConstructorUsedError; bool get twoFactor => throw _privateConstructorUsedError; bool get banned => throw _privateConstructorUsedError; DateTime get createdAt => throw _privateConstructorUsedError; DateTime get updatedAt => throw _privateConstructorUsedError; List<Factor> get factors => throw _privateConstructorUsedError; List<Device> get devices => throw _privateConstructorUsedError;
...
@useResult
$Res call({
 String id, String? firstName, String? lastName, String? email, String? phoneNumber, UserRole role, String? image, bool twoFactor, bool banned, DateTime createdAt, DateTime updatedAt, List<Factor> factors, List<Device> devices
});
...
/// Create a copy of User
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? firstName = freezed,Object? lastName = freezed,Object? email = freezed,Object? phoneNumber = freezed,Object? role = null,Object? image = freezed,Object? twoFactor = null,Object? banned = null,Object? createdAt = null,Object? updatedAt = null,Object? factors = null,Object? devices = null,}) {
...
as bool,banned: null == banned ? _value.banned : banned // ignore: cast_nullable_to_non_nullable
...
class _$UserImpl extends _User  {
  const _$UserImpl({required this.id, required this.firstName, required this.lastName, required this.email, required this.phoneNumber, required this.role, required this.image, required this.twoFactor, required this.banned, required this.createdAt, required this.updatedAt, required final  List<Factor> factors, required final  List<Device> devices}): _factors = factors,_devices = devices,super._();
...
@override
String toString() {
  return 'User(id: $id, firstName: $firstName, lastName: $lastName, email: $email, phoneNumber: $phoneNumber, role: $role, image: $image, twoFactor: $twoFactor, banned: $banned, createdAt: $createdAt, updatedAt: $updatedAt, factors: $factors, devices: $devices)';
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,firstName,lastName,email,phoneNumber,role,image,twoFactor,banned,createdAt,updatedAt,const DeepCollectionEquality().hash(_factors),const DeepCollectionEquality().hash(_devices));
